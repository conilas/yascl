...
grammar Lang is export  {
    ...
    rule statement {
      ...
      | <constructed-field-declaration>
      | <contract-fn-declaration>
    }
    ...
    rule bool-expression-list {
      <expression>* %% <arg-separator>
    }

    rule requires-contruct {
      | "requires" ":" <bool-expression-list> <eol>
    }

    rule ensures-construct {
      | "ensures" ":" <bool-expression-list> <eol>
    }
    ...
    rule constructed-field-declaration {
      | "constructed" <type> <word>
    }

    rule mutable-field-declaration {
      | "mutable" <type> <word>
    }
